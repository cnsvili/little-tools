...
public class RSAUtil {
     ...
     * RSA密文长度:128byte(字节)
     */
    private static final int DECRYPT_BLOCK_CAPACITY = 2 << 6;

    /**
     * RSA明文长度:117byte(字节),padding=11byte(字节)
     */
    private static final int ENCRYPT_BLOCK_CAPACITY = (2 << 6) - 11;
    ...
    public static PublicKey getPublicKey(byte[] encodedKey) throws InvalidKeySpecException {
        // X509
        X509EncodedKeySpec keySpec = new X509EncodedKeySpec(encodedKey);
        return getKeyFactory().generatePublic(keySpec);
    }

    public static PrivateKey getPrivateKey(byte[] encodedKey) throws InvalidKeySpecException {
        // PKCS8
    ...
    public static KeyPairGenerator getGenerator() {
        ...
        try {
            ...
            throw new ToolsException("KeyGenerator for RSA init error.", e);
        }
        // 模值长度
    ...
    private static Cipher getCipher() {
        ...
        try {
            ...
            throw new ToolsException("Cipher for RSA init error.", e);
    ...
    private static KeyFactory getKeyFactory(){
        ...
        try {
            ...
            throw new ToolsException("keyFactory for RSA init error.", e);
        }
        return keyFactory;
    }
